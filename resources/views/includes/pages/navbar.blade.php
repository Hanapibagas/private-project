            ...
            <div class="w-auto">
                <ul class="fixed bg-white inset-0 flex flex-col invisible items-center justify-center opacity-0 md:visible md:flex-row md:bg-transparent md:relative md:opacity-100 md:flex md:items-center"
                    ...
                    <li class="mx-3 py-6 md:py-0">
                        <a href="{{ route('index') }}"
                            class="text-black {{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black' }}-white hover:underline">Showcase</a>
                    </li>
                    <li class="mx-3 py-6 md:py-0">
                        <a href="{{ route('catalog_index') }}"
                            class="text-black {{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black' }}-white hover:underline   ">Catalog</a>
                    </li>
                </ul>
            </div>
            <div class="w-auto">
