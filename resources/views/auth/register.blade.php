            ...
            <div class="card-body p-0">
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block">
                        <img style="margin-left: 100px; margin-top: 90px;"
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input name="no_telpon" type="text"
                                            ...
                                            id="exampleLastName" placeholder="No.Telpon">
                                        @error('no_telpon')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input name="alamat" type="text"
                                            ...
                                            id="exampleFirstName" placeholder="Alamat">
                                        @error('alamat')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="kode_referal" class="form-control form-control-user"
                                            id="exampleLastName" placeholder="Kode Referal">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <hr>
                            <div class="text-center">
                                <a class="small" href="{{ route('login') }}">Apakah anda sudah mempunyai akun ?</a>
                            </div>
                        </div>
                    </div>
                </div>
