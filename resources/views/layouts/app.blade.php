...
<head>
    ...
    <link rel="apple-touch-icon" href="{{ asset('assets/images/content/favicon.png') }}" />

    <link rel="stylesheet" href="{{ asset('assets/css/app.minify.css') }}" />
    <link rel="icon" href="{{ asset('assets/images/content/favicon.png') }}" />

    <meta name="theme-color" content="#000" />
    <link rel="icon" href="{{ asset('favicon.ico') }}">
    <link href="{{ asset('assets/css/app.minify.css') }}" rel="stylesheet">
</head>
        ...
        <div class="container mx-auto py-5">
            <div class="flex flex-stretch items-center">
                <div class="w-56 items-center flex">
                    <img src="{{ asset('assets/images/content/logo.png') }}"
        ...
        <div class="w-full inset-0 md:relative md:w-1/2">
            <div class="relative hero-image">
              ...
              <div class="absolute w-full h-full">
                ...
                <img src="{{ asset('assets/images/content/image-section-1.png') }}" alt="hero 1"
            ...
            <div class="grid grid-rows-2 grid-cols-9 gap-4">
                <div class="relative col-span-9 row-span-1 md:col-span-4 card" style="height: 180px">
                    <div class="card-shadow rounded-xl">
                        <img src="{{ asset('assets/images/content/image-catalog-1.png') }}" alt=""
                ...
                <div class="relative col-span-9 row-span-1 md:col-span-2 md:row-span-2 card">
                    <div class="card-shadow rounded-xl">
                        <img src="{{ asset('assets/images/content/image-catalog-3.png') }}" alt=""
                            class="w-full h-full object-cover object-center overlay overflow-hidden rounded-xl" />
                    </div>
                    <div
                ...
                <div class="relative col-span-9 row-span-1 md:col-span-3 md:row-span-2 card">
                    <div class="card-shadow rounded-xl">
                        <img src="{{ asset('assets/images/content/image-catalog-4.png') }}" alt=""
                            class="w-full h-full object-cover object-center overlay overflow-hidden rounded-xl" />
                    </div>
                    <div
                        class="overlay right-0 left-0 top-0 bottom-0 md:bottom-auto flex justify-center md:items-center flex-col pl-48 md:pl-0 pt-0 md:pt-12">
                ...
                <div class="relative col-span-9 row-span-1 md:col-span-4 card">
                    <div class="card-shadow rounded-xl">
                        <img src="{{ asset('assets/images/content/image-catalog-2.png') }}" alt=""
                            class="w-full h-full object-cover object-center overlay overflow-hidden rounded-xl" />
                    </div>
                    <div class="overlay left-0 top-0 bottom-0 flex justify-center flex-col pl-48 md:pl-72">
    ...
    <section class="container mx-auto">
        <div class="flex justify-center flex-wrap">
            <div class="w-full flex-auto md:w-auto md:flex-initial px-4 md:px-6 my-4 md:my-0">
                <img src="{{ asset('assets/images/content/logo-adobe.svg') }}" alt="" class="mx-auto" />
            </div>
            <div class="w-full flex-auto md:w-auto md:flex-initial px-4 md:px-6 my-4 md:my-0">
                <img src="{{ asset('assets/images/content/logo-ikea.svg') }}" alt="" class="mx-auto" />
            </div>
            <div class="w-full flex-auto md:w-auto md:flex-initial px-4 md:px-6 my-4 md:my-0">
                <img src="{{ asset('assets/images/content/logo-hermanmiller.svg') }}" alt="" class="mx-auto" />
            </div>
            <div class="w-full flex-auto md:w-auto md:flex-initial px-4 md:px-6 my-4 md:my-0">
                <img src="{{ asset('assets/images/content/logo-miele.svg') }}" alt="" class="mx-auto" />
            </div>
        </div>
    </section>
