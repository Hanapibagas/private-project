                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <img src="{{ Storage::disk('public')->exists($banner->banner) ? Storage::url($banner->banner) : url('assets/img/image_not_available.png') }}"
                                    class="rounded img-responsive" alt="{{ $banner->name }}" width="100%"
                                    id="img-preview">
                            </div>
                        </div>
