                        ...
                        <tr>
                            <td align="center" style="padding:0;Margin:0">
                                <table class="es-header-body" align="center" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td align="left"
                                            style="padding:20px;Margin:0;border-radius:10px 10px 0px 0px;background-color:#6366f1"
                                            bgcolor="#6366f1">
                                                                ...
                                                                <td align="center"
                                                                    style="padding:0;Margin:0;font-size:0px"><a
                                                                        ...
                                                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#3D7781;font-size:14px"><img
                                                                            src="https://zsvnwb.stripocdn.email/content/guids/CABINET_bd04f27fe9631049294af955ba6bb983a6f1c52b1021b79bc275c74d1b228964/images/group_69.png"
                                                                            alt="Logo"
                                                                            style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                                                            title="Logo" height="105"></a></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-m-txt-c"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;color:#666666;font-size:15px">
                                                                        jl.Manunggal 22 No. 40 Maccini Sombala, Tamalate
                                                                        Telp.0411-8917345 Makassar 90224 MAKASSAR 90224
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center"
                                                                    style="padding:0;Margin:0;padding-top:15px;padding-right:15px;font-size:0px">
                                                                    <a target="_blank" href="https://viewstripo.email"
                                                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#3D7781;font-size:14px"><img
                                                                            class="adapt-img"
                                                                            src="https://zsvnwb.stripocdn.email/content/guids/CABINET_a258b781aab0bd98d6f802cac9b1796c/images/group_128.png"
                                                                            alt
                                                                            style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                                                            width="290"></a>
                                                                </td>
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        <strong>Halo, {{ $nama }}</strong><br>&nbsp;Kami
                                                                        dari
                                                                        dinas perdaganagn mengabari bahwa status
                                                                        pengaduan anda sebagai berikut !
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center" class="es-m-txt-c"
                                                                    ...
                                                                    <table border="0" width="35%" height="100%"
                                                                        ...
                                                                        <tr>
                                                                            <td
                                                                                style="padding:0;Margin:0;border-bottom:1px solid #fb8500;background:none;height:1px;width:100%;margin:0px">
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-m-txt-c"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:40px;color:#666666;font-size:20px">
                                                                        <span
                                                                            style="font-size:22px"><strong>{{$status}}</strong></span><br>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
